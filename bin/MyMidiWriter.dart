...
//    });
 // }
  ...
  List<List<MidiEvent>> fillInTracks(int timeSigNumerator, int timeSigDenominator, int bpm, int ticksPerBeat, List<Note> notes) {
    ...
    timeSignatureEvent.numerator = timeSigNumerator;
    timeSignatureEvent.denominator = timeSigDenominator;
...
//    print('diffTicks: $diffTicksAsDouble, remainderTicks: $remainderTicksAsDouble');
...
//  void putStuffTogetherIntoMidiFile(List<List<MidiEvent>> listOfTrackEventsLists, MidiHeader midiHeaderOut) {
//    // Add the header and tracks list into a MidiFile, and write it
//    var midiFileOut = MidiFile(listOfTrackEventsLists, midiHeaderOut);
//    var midiWriterCopy = MidiWriter();
//
//  }

//  void writeMidiFileFile(MidiWriter midiWriterCopy, MidiFile midiFileOut, File midiFileOutFile) {
//    midiWriterCopy.writeMidiToFile(midiFileOut, midiFileOutFile);
//
//  }


//  void writeMidiFile(int ticksPerBeat, File midiFileOutFile) {
//
//    // Construct a header with values for name, and whatever else
//    var midiHeaderOut = MidiHeader(ticksPerBeat: ticksPerBeat, format: 1, numTracks:2); // puts this in header with prop "ppq"  What would 2 do?
//
//    // Construct a list to put lists of track events in.  Call it listOfTrackEventsLists
//    var listOfTrackEventsLists = <List<MidiEvent>>[];
//
//    // Construct a list to put track events in.  Call it trackEventsList.
//    var trackEventsList = <MidiEvent>[];
//
//
//    // What is this?  Where?
//    var trackNameEvent = TrackNameEvent();
//    trackNameEvent.text = ''; // strangely puts this in the header, under the prop "name"
//    trackNameEvent.deltaTime = 0;
//    //trackNameEvent.meta = false;
//    //trackNameEvent.running = false;
//    //trackNameEvent.useByte9ForNoteOff = false; // all these are defaults, right?
//    //trackNameEvent.meta
//    trackEventsList.add(trackNameEvent);
//
//    var textEvent = TextEvent();
...
//    textEvent = TextEvent();
//    textEvent.type = 'text';
//    textEvent.text = 'Rob Reed SnareLang 2';
//    trackEventsList.add(textEvent);
//
//    var timeSignatureEvent = TimeSignatureEvent();
//    timeSignatureEvent.type = 'timeSignature';
//    timeSignatureEvent.numerator = 3;
//    timeSignatureEvent.denominator = 4;
//    timeSignatureEvent.metronome = 18;
//    timeSignatureEvent.thirtyseconds = 8;
//    trackEventsList.add(timeSignatureEvent);
//
//    var setTempoEvent = SetTempoEvent();
//    setTempoEvent.type = 'setTempo';
//    setTempoEvent.microsecondsPerBeat = 1000000; // 60bpm
//    trackEventsList.add(setTempoEvent);
//
//    // End of that 'header' track, so add it to the list of lists
//    listOfTrackEventsLists.add(trackEventsList);
//
//
//    // Start a new list
//    trackEventsList = <MidiEvent>[]; // start a new list?
//
//    // noteOnNoteOff(ticksPerBeat, trackEventsList, snareLangNoteNameValue, noteNumber, velocity, channel) {
//    noteOnNoteOff(1, 60, 90, 0, ticksPerBeat, trackEventsList);
//    noteOnNoteOff(4/3, 60, 90, 0, ticksPerBeat, trackEventsList);
////    noteOnNoteOff(4/3, 60, 90, 0, ticksPerBeat, trackEventsList);
//    noteOnNoteOff(2, 60, 90, 0, ticksPerBeat, trackEventsList);
//    noteOnNoteOff(8/3, 60, 90, 0, ticksPerBeat, trackEventsList);
//    noteOnNoteOff(3, 60, 90, 0, ticksPerBeat, trackEventsList);
//    noteOnNoteOff(4, 60, 90, 0, ticksPerBeat, trackEventsList);
//    noteOnNoteOff(5, 60, 90, 0, ticksPerBeat, trackEventsList);
//    noteOnNoteOff(6, 60, 90, 0, ticksPerBeat, trackEventsList);
//    noteOnNoteOff(7, 60, 90, 0, ticksPerBeat, trackEventsList);
//    noteOnNoteOff(8, 60, 90, 0, ticksPerBeat, trackEventsList);
//    noteOnNoteOff(9, 60, 90, 0, ticksPerBeat, trackEventsList);
//    noteOnNoteOff(10, 60, 90, 0, ticksPerBeat, trackEventsList);
//    noteOnNoteOff(11, 60, 90, 0, ticksPerBeat, trackEventsList);
//    noteOnNoteOff(32/3, 60, 90, 0, ticksPerBeat, trackEventsList);
//    for (var ctr = 12; ctr < 65; ctr++) {
//      noteOnNoteOff(ctr, 60, 90, 0, ticksPerBeat, trackEventsList);
//    }
//
//    // Add this second list to the list of lists
//    listOfTrackEventsLists.add(trackEventsList);
